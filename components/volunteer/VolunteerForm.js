    ...
    <div>
      ...
      <input className='text-sm bg-gray-200' ref={emailRef} type='text' required/>
        ...
        <label className='text-xs'>Select Availability</label>
            <select ref={availabilityRef} required class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline text-sm">
            ...
            <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center mt-4 px-2 text-gray-700">
