...
const AdoptForm = ({ pet, setIsFormOpen }) => {
  ...
  async function submit(e) {
    ...
    const adopted = {
      ...
      schedule_pickup: schedulePickUpRef.current.value,
    }
  ...
  return (
    <div className="modal z-40 fade fixed top-0 left-80  w-3/5 outline-none overflow-x-hidden m-20 overflow-y-auto border-2 rounded-md ">
            ...
            <div className="flex">
              <form onSubmit={submit}>
                <div>
                  ...
                  <input
                    className="m-2 border-2 bg-gray-200"
                    ref={firstNameRef}
                    type="text"
                    required
                  />
                ...
                <div className="inline-block relative w-64 mt-5">
                  ...
                  <select
                    ref={schedulePickUpRef}
                    required
                    className="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline text-sm"
                  >
